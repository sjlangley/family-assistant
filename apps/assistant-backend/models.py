...
#   timestamp: 2026-03-10T00:08:18+00:00
...
class ChatCompletionRequestFunctionMessage(BaseModel):
    role: Literal['function'] = Field('function', const=True, title='Role')
...
class ChatCompletionRequestMessageContentPartText(BaseModel):
    type: Literal['text'] = Field('text', const=True, title='Type')
...
class ChatCompletionRequestSystemMessage(BaseModel):
    role: Literal['system'] = Field('system', const=True, title='Role')
    content: str | None = Field(..., title='Content')


class ChatCompletionRequestToolMessage(BaseModel):
    role: Literal['tool'] = Field('tool', const=True, title='Role')
    content: str | None = Field(..., title='Content')
...
class ModelData(BaseModel):
    ...
    object: Literal['model'] = Field('model', const=True, title='Object')
    owned_by: str = Field(..., title='Owned By')
    permissions: list[str] = Field(..., title='Permissions')


class ModelList(BaseModel):
    object: Literal['list'] = Field('list', const=True, title='Object')
...
class ChatCompletionMessageToolCall(BaseModel):
    id: str = Field(..., title='Id')
    type: Literal['function'] = Field('function', const=True, title='Type')
...
class ChatCompletionRequestAssistantMessage(BaseModel):
    role: Literal['assistant'] = Field('assistant', const=True, title='Role')
...
class ChatCompletionRequestMessageContentPartImage(BaseModel):
    type: Literal['image_url'] = Field('image_url', const=True, title='Type')
...
class ChatCompletionRequestUserMessage(BaseModel):
    role: Literal['user'] = Field('user', const=True, title='Role')
    content: (
        str
        | list[
...
class CreateCompletionResponse(BaseModel):
    ...
    object: Literal['text_completion'] = Field(
        'text_completion', const=True, title='Object'
    )
...
class CreateChatCompletionResponse(BaseModel):
    ...
    object: Literal['chat.completion'] = Field(
        'chat.completion', const=True, title='Object'
    )
    created: int = Field(..., title='Created')
    model: str = Field(..., title='Model')
